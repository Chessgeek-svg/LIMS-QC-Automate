...
## Executive Overview
**LIMS-QC-Automate** is a full-stack Laboratory Information Management System designed to modernize the Quality Control (QC) lifecycle. 
...
### **1. The "Basic Automation" Gap**
Many small labs don't use automated lookback systems, and are limited to rigid range checks (typically mean ± 2SD). Without nuanced **Westgard Multi-rule** detection ($1_{3s}, R_{4s}, 2_{2s}$, etc.), laboratories risk "False Rejections" that waste expensive reagents or, more critically, systemic shifts that go undetected by simple standard deviation limits.
...
git clone [[https://github.com/yourusername/clinical-qc-lims.git](https://github.com/Chessgeek-svg/LIMS-QC-Automate)]
cd clinical-qc-lims
